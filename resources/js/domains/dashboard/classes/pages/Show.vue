<template>
    <div class="mb-6">
        <div class="flex justify-center mb-4">
            <h1 class="text-base font-bold leading-6 text-gray-900 text-xl">Klas</h1>
        </div>
        ...
        <dl class="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-3">
            ...
            <div class="overflow-hidden transition hover:scale-105 rounded-lg bg-gray-100 px-4 py-5 shadow sm:p-6">
                ...
                <dd class="mt-1 text-3xl font-semibold tracking-tight text-gray-900">Chart</dd>
            </div>
                    ...
                    <table class="table-auto border-collapse w-full">
                        <thead>
                            <tr class="rounded-lg text-sm bg-grey-200 font-medium text-gray-700 text-left"
                                ...
                                <th class="px-4 py-2 " style="background-color:#f8f8f8">Aanwezig?</th>
                                <th class="px-4 py-2" style="background-color:#f8f8f8;">Acties</th>
                            </tr>
                        </thead>
                        <tbody class="text-gray-700 bg-white">
                            <tr class="hover:bg-gray-100 border-b border-gray-200 py-10">
                                <td class="px-4 py-4">Jaron</td>
                                <td class="px-4 py-4">LOL
                                </td>
                                <td class="">
                                    <button class="px-4 py-4 hover:scale-105">
